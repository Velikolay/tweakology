...
class HTTPRequestActionTest: XCTestCase {
    ...
    func testLoadAttributeFromGetUrl() {
        ...
        HTTPRequestAction(id: "id", urlExpression: urlExpression, attributeName: "RespAttr", httpClient: MockAsyncHTTPClient(), attributeStore: self.attributeStore, expressionProcessor: self.expressionProcessor).execute()
